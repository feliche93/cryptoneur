  ...
  return (
    <div className="tweet my-4 w-full rounded-lg border border-base-200 bg-white px-6 py-4 dark:border-gray-800 dark:bg-gray-900">
      ...
      <div className="mt-2 flex !text-gray-700 dark:!text-gray-300">
        <a
          className="mr-4 flex items-center !text-gray-600 transition hover:!text-blue-600 hover:!underline"
          href={replyUrl}
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          className="mr-4 flex items-center !text-gray-600 transition hover:!text-green-600 hover:!underline"
          href={retweetUrl}
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          className="flex items-center !text-gray-600 transition hover:!text-red-600 hover:!underline"
          href={likeUrl}
          target="_blank"
          rel="noopener noreferrer"
        >
