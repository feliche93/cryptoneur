...
export interface paths {
  ...
  '/items/flow_test': {
    /** List the flow_test items. */
    get: operations['readItemsFlowTest']
    /** Create a new flow_test item. */
    post: operations['createItemsFlowTest']
  }
  '/items/flow_test/{id}': {
    /** Retrieve a single flow_test item by unique identifier. */
    get: operations['readSingleItemsFlowTest']
    /** Delete an existing flow_test item. */
    delete: operations['deleteSingleItemsFlowTest']
    /** Update an existing flow_test item. */
    patch: operations['updateSingleItemsFlowTest']
  }
  '/items/followers': {
  ...
  '/items/gas_fees_calculator': {
    /** List the gas_fees_calculator items. */
    get: operations['readItemsGasFeesCalculator']
    /** Create a new gas_fees_calculator item. */
    post: operations['createItemsGasFeesCalculator']
  }
  '/items/gas_fees_calculator/{id}': {
    /** Retrieve a single gas_fees_calculator item by unique identifier. */
    get: operations['readSingleItemsGasFeesCalculator']
    /** Delete an existing gas_fees_calculator item. */
    delete: operations['deleteSingleItemsGasFeesCalculator']
    /** Update an existing gas_fees_calculator item. */
    patch: operations['updateSingleItemsGasFeesCalculator']
  }
  '/items/gas_fees_calculator_translations': {
    /** List the gas_fees_calculator_translations items. */
    get: operations['readItemsGasFeesCalculatorTranslations']
    /** Create a new gas_fees_calculator_translations item. */
    post: operations['createItemsGasFeesCalculatorTranslations']
  }
  '/items/gas_fees_calculator_translations/{id}': {
    /** Retrieve a single gas_fees_calculator_translations item by unique identifier. */
    get: operations['readSingleItemsGasFeesCalculatorTranslations']
    /** Delete an existing gas_fees_calculator_translations item. */
    delete: operations['deleteSingleItemsGasFeesCalculatorTranslations']
    /** Update an existing gas_fees_calculator_translations item. */
    patch: operations['updateSingleItemsGasFeesCalculatorTranslations']
  }
  '/items/gas_fees_calculator_txn_types': {
    /** List the gas_fees_calculator_txn_types items. */
    get: operations['readItemsGasFeesCalculatorTxnTypes']
    /** Create a new gas_fees_calculator_txn_types item. */
    post: operations['createItemsGasFeesCalculatorTxnTypes']
  }
  '/items/gas_fees_calculator_txn_types/{id}': {
    /** Retrieve a single gas_fees_calculator_txn_types item by unique identifier. */
    get: operations['readSingleItemsGasFeesCalculatorTxnTypes']
    /** Delete an existing gas_fees_calculator_txn_types item. */
    delete: operations['deleteSingleItemsGasFeesCalculatorTxnTypes']
    /** Update an existing gas_fees_calculator_txn_types item. */
    patch: operations['updateSingleItemsGasFeesCalculatorTxnTypes']
  }
  '/items/gas_fees_calculator_txn_types_translations': {
    /** List the gas_fees_calculator_txn_types_translations items. */
    get: operations['readItemsGasFeesCalculatorTxnTypesTranslations']
    /** Create a new gas_fees_calculator_txn_types_translations item. */
    post: operations['createItemsGasFeesCalculatorTxnTypesTranslations']
  }
  '/items/gas_fees_calculator_txn_types_translations/{id}': {
    /** Retrieve a single gas_fees_calculator_txn_types_translations item by unique identifier. */
    get: operations['readSingleItemsGasFeesCalculatorTxnTypesTranslations']
    /** Delete an existing gas_fees_calculator_txn_types_translations item. */
    delete: operations['deleteSingleItemsGasFeesCalculatorTxnTypesTranslations']
    /** Update an existing gas_fees_calculator_txn_types_translations item. */
    patch: operations['updateSingleItemsGasFeesCalculatorTxnTypesTranslations']
  }
  ...
  '/items/organizations': {
    /** List the organizations items. */
    get: operations['readItemsOrganizations']
    /** Create a new organizations item. */
    post: operations['createItemsOrganizations']
  }
  '/items/organizations/{id}': {
    /** Retrieve a single organizations item by unique identifier. */
    get: operations['readSingleItemsOrganizations']
    /** Delete an existing organizations item. */
    delete: operations['deleteSingleItemsOrganizations']
    /** Update an existing organizations item. */
  ...
  '/items/persons': {
    /** List the persons items. */
    get: operations['readItemsPersons']
    /** Create a new persons item. */
    post: operations['createItemsPersons']
  }
  '/items/persons/{id}': {
    /** Retrieve a single persons item by unique identifier. */
    get: operations['readSingleItemsPersons']
    /** Delete an existing persons item. */
    delete: operations['deleteSingleItemsPersons']
    /** Update an existing persons item. */
    patch: operations['updateSingleItemsPersons']
  }
  '/items/persons_translations': {
    /** List the persons_translations items. */
    get: operations['readItemsPersonsTranslations']
    /** Create a new persons_translations item. */
    post: operations['createItemsPersonsTranslations']
  }
  '/items/persons_translations/{id}': {
    /** Retrieve a single persons_translations item by unique identifier. */
    get: operations['readSingleItemsPersonsTranslations']
    /** Delete an existing persons_translations item. */
    delete: operations['deleteSingleItemsPersonsTranslations']
    /** Update an existing persons_translations item. */
  ...
  '/items/web3_grants_events': {
    /** List the web3_grants_events items. */
    get: operations['readItemsWeb3GrantsEvents']
    /** Create a new web3_grants_events item. */
    post: operations['createItemsWeb3GrantsEvents']
  }
  '/items/web3_grants_events/{id}': {
    /** Retrieve a single web3_grants_events item by unique identifier. */
    get: operations['readSingleItemsWeb3GrantsEvents']
    /** Delete an existing web3_grants_events item. */
    delete: operations['deleteSingleItemsWeb3GrantsEvents']
    /** Update an existing web3_grants_events item. */
    patch: operations['updateSingleItemsWeb3GrantsEvents']
  }
  '/items/web3_grants_persons': {
    /** List the web3_grants_persons items. */
    get: operations['readItemsWeb3GrantsPersons']
    /** Create a new web3_grants_persons item. */
    post: operations['createItemsWeb3GrantsPersons']
  }
  '/items/web3_grants_persons/{id}': {
    /** Retrieve a single web3_grants_persons item by unique identifier. */
    get: operations['readSingleItemsWeb3GrantsPersons']
    /** Delete an existing web3_grants_persons item. */
    delete: operations['deleteSingleItemsWeb3GrantsPersons']
    /** Update an existing web3_grants_persons item. */
    patch: operations['updateSingleItemsWeb3GrantsPersons']
  }
...
export interface components {
  schemas: {
    ...
    ItemsBlockButton: {
      ...
      size?: string | null
      shape?: string | null
      translations?: (number | components['schemas']['ItemsBlockButtonTranslations'])[]
    }
    ItemsBlockButtonTranslations: {
      id?: number
      block_button_id?: (number | components['schemas']['ItemsBlockButton']) | null
    ...
    ItemsBlockCal: {
      ...
      date_updated?: string | null
      url?: string | null
      translations?: (number | components['schemas']['ItemsBlockCalTranslations'])[]
    }
    ...
    ItemsBlockFAQ: {
      ...
      user_updated?: (string | components['schemas']['Users']) | null
      date_updated?: string | null
      translations?: (number | components['schemas']['ItemsBlockFAQTranslations'])[]
    }
    ...
    ItemsBlockFeatureGrid: {
      ...
      user_updated?: (string | components['schemas']['Users']) | null
      date_updated?: string | null
      translations?: (number | components['schemas']['ItemsBlockFeatureGridTranslations'])[]
    }
    ItemsBlockFeatureGridTranslations: {
      id?: number
      block_feature_grid_id?: (number | components['schemas']['ItemsBlockFeatureGrid']) | null
      languages_code?: (string | components['schemas']['ItemsLanguages']) | null
    ...
    ItemsBlockFeatures: {
      ...
      user_updated?: (string | components['schemas']['Users']) | null
      date_updated?: string | null
      translations?: (number | components['schemas']['ItemsBlockFeaturesTranslations'])[]
    }
    ItemsBlockFeaturesTranslations: {
      id?: number
      block_features_id?: (number | components['schemas']['ItemsBlockFeatures']) | null
      languages_code?: (string | components['schemas']['ItemsLanguages']) | null
      title?: string | null
      features?: { [key: string]: any } | null
      section?: string | null
    ...
    ItemsBlockFoundersNote: {
      ...
      founder_name?: string
      translations?: (number | components['schemas']['ItemsBlockFoundersNoteTranslations'])[]
    }
    ItemsBlockFoundersNoteTranslations: {
      id?: number
      block_founders_note_id?: (number | components['schemas']['ItemsBlockFoundersNote']) | null
      languages_code?: (string | components['schemas']['ItemsLanguages']) | null
      title?: string
      content?: string | null
    ...
    ItemsBlockHero: {
      ...
      translations?: (number | components['schemas']['ItemsBlockHeroTranslations'])[]
    ...
    ItemsBlockLogoCloud: {
      ...
      user_updated?: (string | components['schemas']['Users']) | null
      date_updated?: string | null
      translations?: (number | components['schemas']['ItemsBlockLogoCloudTranslations'])[]
      images?: (number | components['schemas']['ItemsBlockLogoCloudFiles'])[]
    }
    ItemsBlockLogoCloudFiles: {
      id?: number
      block_logo_cloud_id?: (number | components['schemas']['ItemsBlockLogoCloud']) | null
    ...
    ItemsBlockTitle: {
      ...
      user_updated?: (string | components['schemas']['Users']) | null
      date_updated?: string | null
      translations?: (number | components['schemas']['ItemsBlockTitleTranslations'])[]
    }
    ItemsBlockTitleTranslations: {
      id?: number
      block_title_id?: (number | components['schemas']['ItemsBlockTitle']) | null
      languages_code?: (string | components['schemas']['ItemsLanguages']) | null
    }
    ItemsBlockchains: {
      id?: number
    ...
    ItemsGasFeesCalculator: {
      id?: number
      user_created?: (string | components['schemas']['Users']) | null
      date_created?: string | null
      user_updated?: (string | components['schemas']['Users']) | null
      date_updated?: string | null
      gitcoin_logo?: (string | components['schemas']['Files']) | null
      zapper_logo?: (string | components['schemas']['Files']) | null
      translations?: (number | components['schemas']['ItemsGasFeesCalculatorTranslations'])[]
    }
    ItemsGasFeesCalculatorTranslations: {
      id?: number
      gas_fees_calculator_id?: (number | components['schemas']['ItemsGasFeesCalculator']) | null
      languages_code?: (string | components['schemas']['ItemsLanguages']) | null
      header_title?: string
      head_subtitle?: string
      header_description?: string
      gitcoin_title?: string | null
      share_button_title?: string | null
      table_header_name?: string | null
      table_header_type?: string | null
      table_header_token?: string | null
      table_header_gas_used?: string | null
    ...
    ItemsGasFeesCalculatorTxnTypes: {
      ...
      translations?: (
        | number
        | components['schemas']['ItemsGasFeesCalculatorTxnTypesTranslations']
      )[]
    }
    ItemsGasFeesCalculatorTxnTypesTranslations: {
      id?: number
      gas_fees_calculator_txn_types_id?:
        | (number | components['schemas']['ItemsGasFeesCalculatorTxnTypes'])
        | null
      languages_code?: (string | components['schemas']['ItemsLanguages']) | null
      name?: string | null
      source?: string | null
    ...
    ItemsGrantProjects: {
      ...
      amount_requested_curency?: (number | components['schemas']['ItemsFiats']) | null
    ...
    ItemsGrants: {
      ...
      funding_minimum_currency?: (number | components['schemas']['ItemsFiats']) | null
      funding_maximum_currency?: (number | components['schemas']['ItemsFiats']) | null
      github?: string | null
      discord?: string | null
    ...
    ItemsPages: {
      ...
      translations?: (number | components['schemas']['ItemsPagesTranslations'])[]
    ...
    ItemsPersons: {
      ...
      last_name?: string
      avatar?: (string | components['schemas']['Files']) | null
      translations?: (number | components['schemas']['ItemsPersonsTranslations'])[]
    }
    ItemsPersonsTranslations: {
      id?: number
      persons_id?: (number | components['schemas']['ItemsPersons']) | null
      languages_code?: (string | components['schemas']['ItemsLanguages']) | null
    ...
    ItemsRfps: {
      ...
      priority_id?: (number | components['schemas']['ItemsRfpPriorities']) | null
    }
    ItemsSEO: {
      id?: number
      sort?: number | null
    ...
    ItemsWeb3Categories: {
      ...
      user_updated?: (string | components['schemas']['Users']) | null
      date_updated?: string | null
      translations?: (number | components['schemas']['ItemsWeb3CategoriesTranslations'])[]
    }
    ItemsWeb3CategoriesTranslations: {
      id?: number
      web3_categories_id?: (number | components['schemas']['ItemsWeb3Categories']) | null
      languages_code?: (string | components['schemas']['ItemsLanguages']) | null
      name?: string | null
    }
    ItemsWeb3Grants: {
      ...
      funding_minimum_currency_id?: (number | components['schemas']['ItemsCurrencies']) | null
      funding_maximum_currency_id?: (number | components['schemas']['ItemsCurrencies']) | null
      /** Which categories best match the grant */
      grant_categories?: (number | components['schemas']['ItemsWeb3GrantsWeb3Categories'])[]
      translations?: (number | components['schemas']['ItemsWeb3GrantsTranslations'])[]
      ...
      grant_blockchains?: (number | components['schemas']['ItemsWeb3GrantsWeb3Blockchains'])[]
      /** Which use cases does the grant suggest */
      grant_use_cases?: (number | components['schemas']['ItemsWeb3GrantsWeb3UseCases'])[]
      contact_persons?: (number | components['schemas']['ItemsWeb3GrantsPersons'])[]
      events?: (number | components['schemas']['ItemsWeb3GrantsEvents'])[]
    }
    ItemsWeb3GrantsDetailPage: {
      ...
      user_updated?: (string | components['schemas']['Users']) | null
      date_updated?: string | null
      translations?: (number | components['schemas']['ItemsWeb3GrantsDetailPageTranslations'])[]
    }
    ...
    ItemsWeb3GrantsEvents: {
      id?: number
      web3_grants_id?: (number | components['schemas']['ItemsWeb3Grants']) | null
      events_id?: (number | components['schemas']['ItemsEvents']) | null
    }
    ItemsWeb3GrantsPersons: {
      id?: number
      web3_grants_id?: (number | components['schemas']['ItemsWeb3Grants']) | null
      persons_id?: (number | components['schemas']['ItemsPersons']) | null
    }
    ...
    ItemsWeb3GrantsWeb3Blockchains: {
      id?: number
      web3_grants_id?: (number | components['schemas']['ItemsWeb3Grants']) | null
      web3_blockchains_id?: (number | components['schemas']['ItemsWeb3Blockchains']) | null
    }
    ...
    ItemsWeb3GrantsWeb3UseCases: {
      id?: number
      web3_grants_id?: (number | components['schemas']['ItemsWeb3Grants']) | null
      web3_use_cases_id?: (number | components['schemas']['ItemsWeb3UseCases']) | null
    }
    ItemsWeb3RfpPriorities: {
      ...
      user_updated?: (string | components['schemas']['Users']) | null
      date_updated?: string | null
      translations?: (number | components['schemas']['ItemsWeb3RfpPrioritiesTranslations'])[]
    }
    ItemsWeb3RfpPrioritiesTranslations: {
      id?: number
      web3_rfp_priorities_id?: (number | components['schemas']['ItemsWeb3RfpPriorities']) | null
      languages_code?: (string | components['schemas']['ItemsLanguages']) | null
    ...
    ItemsWeb3RfpStatuses: {
      ...
      user_updated?: (string | components['schemas']['Users']) | null
      date_updated?: string | null
      translations?: (number | components['schemas']['ItemsWeb3RfpStatusesTranslations'])[]
    }
    ItemsWeb3RfpStatusesTranslations: {
      id?: number
      web3_rfp_statuses_id?: (number | components['schemas']['ItemsWeb3RfpStatuses']) | null
      languages_code?: (string | components['schemas']['ItemsLanguages']) | null
      status?: string | null
    }
    ItemsWeb3Rfps: {
      ...
      funding_minimum?: number | null
      funding_maximum?: number | null
      funding_mimum_currency_id?: (number | components['schemas']['ItemsCurrencies']) | null
      funding_maximum_currency_id?: (number | components['schemas']['ItemsCurrencies']) | null
      deadline_at?: string | null
      rfp_status?: (number | components['schemas']['ItemsWeb3RfpStatuses']) | null
      priority?: (number | components['schemas']['ItemsWeb3RfpPriorities']) | null
      slug?: string | null
      translations?: (number | components['schemas']['ItemsWeb3RfpsTranslations'])[]
    }
    ...
    ItemsWeb3UseCases: {
      ...
      user_updated?: (string | components['schemas']['Users']) | null
      date_updated?: string | null
      translations?: (number | components['schemas']['ItemsWeb3UseCasesTranslations'])[]
    }
...
export interface operations {
  ...
  readItemsFlowTest: {
    ...
    responses: {
      ...
      200: {
        content: {
          'application/json': {
            data?: components['schemas']['ItemsFlowTest'][]
            meta?: components['schemas']['x-metadata']
          }
        }
      }
  ...
  createItemsFlowTest: {
    ...
    requestBody: {
      content: {
        'application/json':
          | components['schemas']['ItemsFlowTest'][]
          | components['schemas']['ItemsFlowTest']
      }
    }
  }
  /** Retrieve a single flow_test item by unique identifier. */
  readSingleItemsFlowTest: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components['parameters']['Fields']
  ...
  updateSingleItemsFlowTest: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['ItemsFlowTest']
      }
    }
  }
  /** List the followers items. */
  ...
  readItemsGasFeesCalculator: {
    ...
    responses: {
      ...
      200: {
        content: {
          'application/json': {
            data?: components['schemas']['ItemsGasFeesCalculator'][]
            meta?: components['schemas']['x-metadata']
          }
        }
      }
  ...
  createItemsGasFeesCalculator: {
    ...
    requestBody: {
      content: {
        'application/json':
          | components['schemas']['ItemsGasFeesCalculator'][]
          | components['schemas']['ItemsGasFeesCalculator']
      }
    }
  }
  /** Retrieve a single gas_fees_calculator item by unique identifier. */
  readSingleItemsGasFeesCalculator: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components['parameters']['Fields']
  ...
  /** Delete an existing gas_fees_calculator item. */
  deleteSingleItemsGasFeesCalculator: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string
  ...
  /** Update an existing gas_fees_calculator item. */
  updateSingleItemsGasFeesCalculator: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components['parameters']['Fields']
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['ItemsGasFeesCalculator']
      }
    }
  }
  /** List the gas_fees_calculator_translations items. */
  readItemsGasFeesCalculatorTranslations: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components['parameters']['Fields']
    ...
    responses: {
      ...
      200: {
        content: {
          'application/json': {
            data?: components['schemas']['ItemsGasFeesCalculatorTranslations'][]
            meta?: components['schemas']['x-metadata']
          }
        }
      }
  ...
  /** Create a new gas_fees_calculator_translations item. */
  createItemsGasFeesCalculatorTranslations: {
    parameters: {
      query: {
        /** What metadata to return in the response. */
        meta?: components['parameters']['Meta']
    ...
    requestBody: {
      content: {
        'application/json':
          | components['schemas']['ItemsGasFeesCalculatorTranslations'][]
          | components['schemas']['ItemsGasFeesCalculatorTranslations']
      }
    }
  }
  /** Retrieve a single gas_fees_calculator_translations item by unique identifier. */
  readSingleItemsGasFeesCalculatorTranslations: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components['parameters']['Fields']
  ...
  /** Delete an existing gas_fees_calculator_translations item. */
  deleteSingleItemsGasFeesCalculatorTranslations: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string
  ...
  /** Update an existing gas_fees_calculator_translations item. */
  updateSingleItemsGasFeesCalculatorTranslations: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components['parameters']['Fields']
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['ItemsGasFeesCalculatorTranslations']
      }
    }
  }
  /** List the gas_fees_calculator_txn_types items. */
  readItemsGasFeesCalculatorTxnTypes: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components['parameters']['Fields']
    ...
    responses: {
      ...
      200: {
        content: {
          'application/json': {
            data?: components['schemas']['ItemsGasFeesCalculatorTxnTypes'][]
            meta?: components['schemas']['x-metadata']
          }
        }
      }
  ...
  /** Create a new gas_fees_calculator_txn_types item. */
  createItemsGasFeesCalculatorTxnTypes: {
    parameters: {
      query: {
        /** What metadata to return in the response. */
        meta?: components['parameters']['Meta']
    ...
    requestBody: {
      content: {
        'application/json':
          | components['schemas']['ItemsGasFeesCalculatorTxnTypes'][]
          | components['schemas']['ItemsGasFeesCalculatorTxnTypes']
      }
    }
  }
  /** Retrieve a single gas_fees_calculator_txn_types item by unique identifier. */
  readSingleItemsGasFeesCalculatorTxnTypes: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components['parameters']['Fields']
  ...
  /** Delete an existing gas_fees_calculator_txn_types item. */
  deleteSingleItemsGasFeesCalculatorTxnTypes: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string
  ...
  /** Update an existing gas_fees_calculator_txn_types item. */
  updateSingleItemsGasFeesCalculatorTxnTypes: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components['parameters']['Fields']
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['ItemsGasFeesCalculatorTxnTypes']
      }
    }
  }
  /** List the gas_fees_calculator_txn_types_translations items. */
  readItemsGasFeesCalculatorTxnTypesTranslations: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components['parameters']['Fields']
    ...
    responses: {
      ...
      200: {
        content: {
          'application/json': {
            data?: components['schemas']['ItemsGasFeesCalculatorTxnTypesTranslations'][]
            meta?: components['schemas']['x-metadata']
          }
        }
      }
  ...
  /** Create a new gas_fees_calculator_txn_types_translations item. */
  createItemsGasFeesCalculatorTxnTypesTranslations: {
    parameters: {
      query: {
        /** What metadata to return in the response. */
        meta?: components['parameters']['Meta']
  ...
  /** Retrieve a single gas_fees_calculator_txn_types_translations item by unique identifier. */
  readSingleItemsGasFeesCalculatorTxnTypesTranslations: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components['parameters']['Fields']
  ...
  /** Delete an existing gas_fees_calculator_txn_types_translations item. */
  deleteSingleItemsGasFeesCalculatorTxnTypesTranslations: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string
  ...
  /** Update an existing gas_fees_calculator_txn_types_translations item. */
  updateSingleItemsGasFeesCalculatorTxnTypesTranslations: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components['parameters']['Fields']
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['ItemsGasFeesCalculatorTxnTypesTranslations']
      }
    }
  }
  /** List the grant_blockchains items. */
  ...
  createItemsOrganizations: {
    ...
    requestBody: {
      content: {
        'application/json':
          | components['schemas']['ItemsOrganizations'][]
          | components['schemas']['ItemsOrganizations']
      }
    }
  }
  ...
  /** Delete an existing persons_translations item. */
  deleteSingleItemsPersonsTranslations: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string
  ...
  readItemsWeb3GrantsEvents: {
    ...
    responses: {
      ...
      200: {
        content: {
          'application/json': {
            data?: components['schemas']['ItemsWeb3GrantsEvents'][]
            meta?: components['schemas']['x-metadata']
          }
        }
      }
  ...
  createItemsWeb3GrantsEvents: {
    ...
    requestBody: {
      content: {
        'application/json':
          | components['schemas']['ItemsWeb3GrantsEvents'][]
          | components['schemas']['ItemsWeb3GrantsEvents']
      }
    }
  }
  /** Retrieve a single web3_grants_events item by unique identifier. */
  readSingleItemsWeb3GrantsEvents: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components['parameters']['Fields']
  ...
  /** Delete an existing web3_grants_events item. */
  deleteSingleItemsWeb3GrantsEvents: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string
  ...
  /** Update an existing web3_grants_events item. */
  updateSingleItemsWeb3GrantsEvents: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components['parameters']['Fields']
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['ItemsWeb3GrantsEvents']
      }
    }
  }
  /** List the web3_grants_persons items. */
  readItemsWeb3GrantsPersons: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components['parameters']['Fields']
    ...
    responses: {
      ...
      200: {
        content: {
          'application/json': {
            data?: components['schemas']['ItemsWeb3GrantsPersons'][]
            meta?: components['schemas']['x-metadata']
          }
        }
      }
  ...
  createItemsWeb3GrantsPersons: {
    ...
    requestBody: {
      content: {
        'application/json':
          | components['schemas']['ItemsWeb3GrantsPersons'][]
          | components['schemas']['ItemsWeb3GrantsPersons']
      }
    }
  }
  /** Retrieve a single web3_grants_persons item by unique identifier. */
  readSingleItemsWeb3GrantsPersons: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components['parameters']['Fields']
  ...
  /** Delete an existing web3_grants_persons item. */
  deleteSingleItemsWeb3GrantsPersons: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string
  ...
  /** Update an existing web3_grants_persons item. */
  updateSingleItemsWeb3GrantsPersons: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components['parameters']['Fields']
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['ItemsWeb3GrantsPersons']
      }
    }
  }
  /** List the web3_grants_translations items. */
...
export type DirectusCollections = {
  ...
  flow_test: components['schemas']['ItemsFlowTest']
  followers: components['schemas']['ItemsFollowers']
  gas_fees_calculator: components['schemas']['ItemsGasFeesCalculator']
  gas_fees_calculator_translations: components['schemas']['ItemsGasFeesCalculatorTranslations']
  gas_fees_calculator_txn_types: components['schemas']['ItemsGasFeesCalculatorTxnTypes']
  gas_fees_calculator_txn_types_translations: components['schemas']['ItemsGasFeesCalculatorTxnTypesTranslations']
  ...
  persons: components['schemas']['ItemsPersons']
  persons_translations: components['schemas']['ItemsPersonsTranslations']
  ...
  web3_grants_events: components['schemas']['ItemsWeb3GrantsEvents']
  web3_grants_persons: components['schemas']['ItemsWeb3GrantsPersons']
